"""
Colab'da TensorFlow 2.17.0 ile Model Dönüştürme
JAX/ml_dtypes sorununu atlamak için TensorFlow 2.17.0 kullanıyoruz
"""
...
# Önce mevcut TensorFlow'u kaldır (opsiyonel)
# !pip uninstall tensorflow -y

# TensorFlow 2.17.0'ı yükle (JAX sorununu atlar)
...
# TFLite'e dönüştür
print("\\n🔄 TFLite'e dönüştürülüyor (TensorFlow 2.17.0 ile)...")
...
# Kaydet
output_path = "/content/final_stress_model_flex_tf217.tflite"
...
# Drive'a kopyala
drive_path = os.path.join(base_dir, "final_stress_model_flex_tf217.tflite")
import shutil
