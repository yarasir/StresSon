"""
Colab'da TensorFlow 2.18.0 ile Model Dönüştürme - FINAL ÇÖZÜM
ml_dtypes sorununu çözer
"""

print("""
# ============================================================
# COLAB'DA BU KODU ÇALIŞTIRIN (SIRAYLA)
# ============================================================

# 1. Önce ml_dtypes'ı güncelle
!pip install --upgrade ml_dtypes

# 2. TensorFlow 2.18.0'ı yükle
!pip install tensorflow==2.18.0

# 3. Runtime'ı yeniden başlatın: Runtime → Restart runtime
